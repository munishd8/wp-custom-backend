...
class AT_Meta_Box {
  ...
  public function __construct ( $meta_box ) {
    ...
    if (isset($meta_box['use_with_theme']))
      if ($meta_box['use_with_theme'] === true){
        $this->SelfPath = get_stylesheet_directory_uri() . '/add-ons/meta-box-class';
      }elseif($meta_box['use_with_theme'] === false){
        $this->SelfPath = get_stylesheet_directory_uri( 'meta-box-class', plugin_basename( dirname( __FILE__ ) ) );
      }else{
  ...
  public function load_scripts_styles() {
    ...
    // Get Plugin Path
    $plugin_path = get_stylesheet_directory_uri() . '/add-ons/meta-box-class';
